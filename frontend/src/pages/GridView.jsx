...
const GridView = () => {
  const [products, setProducts] = useState(MOCK_GRID_PRODUCTS)
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 mb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm text-left">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center border border-gray-200 rounded-md bg-white overflow-hidden">
                  <Link to={`/grid?category=${category}`} className="p-2 bg-gray-100 hover:bg-gray-200 transition-colors border-r border-gray-200">
                    <svg className="w-5 h-5 text-gray-900" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                    </svg>
                  </Link>
                  <Link to={`/list?category=${category}`} className="p-2 hover:bg-gray-50 transition-colors">
